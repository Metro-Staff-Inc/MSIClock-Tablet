...
- Per-tenant theming with bundled presets ("Metro Staff", "BAC") selectable from Admin Settings
- Custom logo upload override per tablet
- BAC theme preset with red palette
